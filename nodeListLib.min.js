...
}return this},querySelectorAll:function(a){for(var c=[],b=0,g=this.length;b<g;b++){for(var d=[],e=this[b].querySelectorAll(a),f=0,h=e.length;f<h;f++)d.push(e[f]);c.push(d)}return l(c)},get:function(a){for(var c=[],b=0,g=this.length;b<g;b++){var d=this[b][a];-1===c.indexOf(d)&&c.push(d)}return l(c)},set:function(a,c,b){if(b){b=0;for(var g=this.length;b<g;b++){var d=this[b];void 0!==d[a]&&(d[a]=c)}}else for(b=0,g=this.length;b<g;b++)this[b][a]=c;return this}};window.Symbol&&window.Symbol.iterator&&
