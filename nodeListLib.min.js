...
[],c=[],d=0,e=this.length;d<e;d++){var f=this[d],f=f[a].apply(f,arguments);f instanceof Node?-1===c.indexOf(f)&&c.push(f):void 0!==f&&b.push(f)}return c.length?(c.__proto__=h,c):b.length?b:this})}catch(c){Object.defineProperty(h,a,{get:function(){for(var b=[],c=0,d=this.length;c<d;c++){var e=this[c][a];("string"===typeof e||"object"===typeof e&&-1===b.indexOf(e))&&b.push(e)}return l(b)},set:function(b){for(var c=0,d=this.length;c<d;c++)this[c][a]=b}})}}var h={keys:Array.prototype.keys,entries:Array.prototype.entries,
indexOf:Array.prototype.indexOf,lastIndexOf:Array.prototype.lastIndexOf,every:Array.prototype.every,some:Array.prototype.some,reduce:Array.prototype.reduce,reduceRight:Array.prototype.reduceRight,pop:Array.prototype.pop,shift:Array.prototype.shift,sort:Array.prototype.sort,reverse:Array.prototype.reverse,values:Array.prototype.values||k("values"),find:Array.prototype.find||k("find"),findIndex:Array.prototype.findIndex||k("findIndex"),copyWithin:Array.prototype.copyWithin||k("copyWithin"),includes:Array.prototype.includes||
...
}return this},querySelectorAll:function(a){for(var c=[],b=0,g=this.length;b<g;b++){for(var d=[],e=this[b].querySelectorAll(a),f=0,h=e.length;f<h;f++)d.push(e[f]);c.push(d)}return l(c)},get:function(a){for(var c=[],b=0,g=this.length;b<g;b++){var d=this[b][a];("string"===typeof d||"object"===typeof d&&-1===c.indexOf(d))&&c.push(d)}return l(c)},set:function(a,c,b){if(b){b=0;for(var g=this.length;b<g;b++){var d=this[b];void 0!==d[a]&&(d[a]=c)}}else for(b=0,g=this.length;b<g;b++)this[b][a]=c;return this}};
window.Symbol&&window.Symbol.iterator&&(h[Symbol.iterator]=Array.prototype[Symbol.iterator]);var p=document.createElement("div"),m;for(m in p)n(m);window.$=function(a){a=document.querySelectorAll(a);for(var c=[],b=0,g=a.length;b<g;b++)c.push(a[b]);c.__proto__=h;return c};window.$.NL=h})();
